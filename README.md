...
- Icon Pack: [https://www.astroicon.dev/getting-started/](https://www.astroicon.dev/getting-started/)
- Add new icon pack - `npm install @iconify-json/simple-icons --save-dev`
- Use `<Icon name="simple-icons:icon" />`
